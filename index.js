...
app.get("/movies", async function (request, response){
  ...
  const allDatas = await client.db("Ragav").collection("movies").find(request.query).toArray();
...
app.get("/movies/:id", async function(request, response){
  ...
  const getSingleData = await client.db("Ragav").collection("movies").findOne({id: id})
...
app.post("/movies", async function(request, response){
  ...
  const createData = await client.db("Ragav").collection("movies").insertMany(createRequest);
...
app.delete("/movies/:id", async function(request, response){
  ...
  const deleteData = await client.db("Ragav").collection("movies").deleteOne({id: id})
...
app.put("/movies/:id", async function(request, response){
  ...
  const updateData = await client.db("Ragav").collection("movies").updateOne({ id: id }, { $set: updateRequest });
